	...
	<body class="baseFont">
		...
		<div id="main">
			<div class="menu grad grayBorders">
				...
				<a href="?menu=magazines"><input class="button baseFont menu_button" type="button" value="Magazines"></a>
			</div>
			<div id="adding">
				<?php 
					if( $_GET['menu'] == "ships" ) {
					...
					} elseif( $_GET['menu'] == "magazines" ) {
						include( "magazines/magazines_adding.php" );
					} else {
			...
			<div class="left_group grad grayBorders">
				<?php 
					if( $_GET['menu'] == "ships" ) {
						...
						include( "magazines/magazines_left_group.php" );
					} else {
			...
			<div class="desc grad grayBorders">
				<?php 
					if( $_GET['menu'] == "ships" ) {
						...
						include( "magazines/magazines_desc_field.php" );
					} else {
