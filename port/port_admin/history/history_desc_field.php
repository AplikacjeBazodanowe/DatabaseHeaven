<?php
	...
	if( isset( $_GET['id'] ) ) 
	{
		...
		{			
            ...
            echo '<a href="?menu=history&id=' . $_GET['id'] . '&stuff=now"><input class="button baseFont add" type="submit" value="Show cargo on the ship"></a><br>';
            echo '<br>';
            echo '<form action="?menu=history&id=' . $_GET['id'] . '&stuff=history" method="post">';
